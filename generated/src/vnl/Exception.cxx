...
void Exception::destroy() {
	...
	return vnl::global_pool->push_back(this, sizeof(Exception));
}
...
int Exception::field_index(vnl::Hash32 _hash) const {
	switch(_hash) {
		default: return -1;
	}
}

const char* Exception::field_name(int _index) const {
	switch(_index) {
		default: return 0;
	}
}
