...
int TopicInfo::get_field_index(vnl::Hash32 _hash) const {
	switch(_hash) {
		...
		case 0xf56f7d1e: return 2;
		case 0xbafcf9f0: return 3;
		case 0x50ad8a03: return 4;
		case 0x13c371be: return 5;
		default: return -1;
	}
}
...
const char* TopicInfo::get_field_name(int _index) const {
	switch(_index) {
		...
		case 2: return "send_counter";
		case 3: return "receive_counter";
		case 4: return "first_time";
		case 5: return "last_time";
		default: return 0;
	}
}
...
void TopicInfo::get_field(int _index, vnl::String& _str) const {
	switch(_index) {
		...
		case 2: vnl::to_string(_str, send_counter); break;
		case 3: vnl::to_string(_str, receive_counter); break;
		case 4: vnl::to_string(_str, first_time); break;
		case 5: vnl::to_string(_str, last_time); break;
	}
}
...
void TopicInfo::set_field(int _index, const vnl::String& _str) {
	switch(_index) {
		...
		case 2: vnl::from_string(_str, send_counter); break;
		case 3: vnl::from_string(_str, receive_counter); break;
		case 4: vnl::from_string(_str, first_time); break;
		case 5: vnl::from_string(_str, last_time); break;
	}
}
...
void TopicInfo::get_field(int _index, vnl::io::TypeOutput& _out) const {
	switch(_index) {
		...
		case 2: vnl::write(_out, send_counter); break;
		case 3: vnl::write(_out, receive_counter); break;
		case 4: vnl::write(_out, first_time); break;
		case 5: vnl::write(_out, last_time); break;
...
void TopicInfo::set_field(int _index, vnl::io::TypeInput& _in) {
	switch(_index) {
		...
		case 2: vnl::read(_in, send_counter); break;
		case 3: vnl::read(_in, receive_counter); break;
		case 4: vnl::read(_in, first_time); break;
		case 5: vnl::read(_in, last_time); break;
	}
}
