...
int TcpClientBase::field_index(vnl::Hash32 _hash) const {
	switch(_hash) {
		...
		case 0x2dc3f0d0: return 6;
		case 0x13e7a893: return 7;
		case 0x56a15978: return 8;
...
void TcpClientBase::get_field(int _index, vnl::String& _str) const {
	switch(_index) {
		...
		case 6: vnl::to_string(_str, endpoint); break;
		case 7: vnl::to_string(_str, port); break;
		case 8: vnl::to_string(_str, autoclose); break;
...
void TcpClientBase::set_field(int _index, const vnl::String& _str) {
	switch(_index) {
		...
		case 6: vnl::from_string(_str, endpoint); break;
		case 7: vnl::from_string(_str, port); break;
		case 8: vnl::from_string(_str, autoclose); break;
...
void TcpClientBase::get_field(int _index, vnl::io::TypeOutput& _out) const {
	switch(_index) {
		...
		case 6: vnl::write(_out, endpoint); break;
		case 7: vnl::write(_out, port); break;
		case 8: vnl::write(_out, autoclose); break;
...
void TcpClientBase::set_field(int _index, vnl::io::TypeInput& _in) {
	switch(_index) {
		...
		case 6: vnl::read(_in, endpoint); break;
		case 7: vnl::read(_in, port); break;
		case 8: vnl::read(_in, autoclose); break;
