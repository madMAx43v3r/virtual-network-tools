...
#ifndef INCLUDE_VNI_GENERATED_vnl_info_TypeName_HXX_
#define INCLUDE_VNI_GENERATED_vnl_info_TypeName_HXX_
...
class TypeName : public vnl::Value {
public:
	static const uint32_t VNI_HASH = 0x7450a5b3;
	static const uint32_t NUM_FIELDS = 3;
	
	
	vnl::Hash32 hash;
	vnl::String name;
	vnl::List<vnl::String > generics;
	...
	virtual const char* get_type_name() const { return "vnl.info.TypeName"; }
	
	virtual int get_type_size() const { return sizeof(TypeName); }
...
#endif // INCLUDE_VNI_GENERATED_vnl_info_TypeName_HXX_
