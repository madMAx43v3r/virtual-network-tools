...
protected:
	...
	virtual void handle(const vnl::Value& sample, const vnl::Packet& packet) { handle(sample); }
	virtual void handle(const vnl::Value& sample, vnl::Basic* input) { handle(sample); }
	virtual void handle(const vnl::Value& sample) {}
